        ...
        CallDetail.enqueue(new Callback<ProductDetailPageRespones>() {
            ...
            public void onResponse(Call<ProductDetailPageRespones> call, Response<ProductDetailPageRespones> response) {
                ...
                try {
                    ...
                    if(product.get(0).getTechnical_name().toUpperCase().contains("NA") || product.get(0).getTechnical_name()== null || product.get(0).getTechnical_name().isEmpty()){
                    ...
                    if(product.get(0).getDescription().toUpperCase().contains("NA") || product.get(0).getDescription()== null || product.get(0).getDescription().isEmpty()){
                    ...
                    if(product.get(0).getTarget_disease().toUpperCase().contains("NA") || product.get(0).getTarget_disease()== null || product.get(0).getTarget_disease().isEmpty()){
                    ...
                    if(product.get(0).getTarget_field_crops().toUpperCase().contains("NA") || product.get(0).getTarget_field_crops()== null || product.get(0).getTarget_field_crops().isEmpty()){
                    ...
                    if(product.get(0).getTarget_vegetable_crops().toUpperCase().contains("NA") || product.get(0).getTarget_vegetable_crops()== null || product.get(0).getTarget_vegetable_crops().isEmpty()){
                    ...
                    if(product.get(0).getTarget_fruit_crops().toUpperCase().contains("NA") || product.get(0).getTarget_fruit_crops()== null|| product.get(0).getTarget_fruit_crops().isEmpty()){
                    ...
                    if(product.get(0).getTarget_plantation_crops().toUpperCase().contains("NA") || product.get(0).getTarget_plantation_crops()== null|| product.get(0).getTarget_plantation_crops().isEmpty()){
                    ...
                    if(product.get(0).getMode_of_action().toUpperCase().contains("NA") || product.get(0).getMode_of_action()== null || product.get(0).getMode_of_action().isEmpty()){
                    ...
                    if(product.get(0).getDuration_of_effect().toUpperCase().contains("NA") || product.get(0).getDuration_of_effect()== null || product.get(0).getDuration_of_effect().isEmpty()){
                    ...
                    if(product.get(0).getCompatability_with_other_chemicals().toUpperCase().contains("NA") || product.get(0).getCompatability_with_other_chemicals()== null|| product.get(0).getCompatability_with_other_chemicals().isEmpty()){
                    ...
                    if(product.get(0).getFrequency_of_application().toUpperCase().contains("NA") || product.get(0).getFrequency_of_application()== null || product.get(0).getFrequency_of_application().isEmpty()){
                    ...
                    if(product.get(0).getDosage().toUpperCase().contains("NA") || product.get(0).getDosage()== null || product.get(0).getDosage().isEmpty()){
                    ...
                    if(product.get(0).getWater_requirement().toUpperCase().contains("NA") || product.get(0).getWater_requirement()== null || product.get(0).getWater_requirement().isEmpty()){
                    ...
                    if(product.get(0).getTime_of_application().toUpperCase().contains("NA") || product.get(0).getTime_of_application()== null || product.get(0).getTime_of_application().isEmpty()){
                    ...
                    if(product.get(0).getMethod_of_application().toUpperCase().contains("NA") || product.get(0).getMethod_of_application()== null || product.get(0).getMethod_of_application().isEmpty()){
                    ...
                    if(product.get(0).getWaiting_period().toUpperCase().contains("NA") || product.get(0).getWaiting_period()== null || product.get(0).getWaiting_period().isEmpty()){
                    ...
                    if(product.get(0).getStorage().toUpperCase().contains("NA") || product.get(0).getStorage()== null || product.get(0).getStorage().isEmpty()){
                    ...
                    if(product.get(0).getPhytotoxicity().toUpperCase().contains("NA") || product.get(0).getPhytotoxicity()== null || product.get(0).getPhytotoxicity().isEmpty()){
                    ...
                    if(product.get(0).getCountry_of_origin().toUpperCase().contains("NA") || product.get(0).getCountry_of_origin()== null || product.get(0).getCountry_of_origin().isEmpty()){
                    ...
                    if(product.get(0).getVolume().toUpperCase().contains("NA") || product.get(0).getVolume()== null || product.get(0).getVolume().isEmpty()){
                    ...
                    if(product.get(0).getDimensions().toUpperCase().contains("NA") || product.get(0).getDimensions()== null|| product.get(0).getDimensions().isEmpty()){
                    ...
                    if(product.get(0).getState().toUpperCase().contains("NA") || product.get(0).getState()== null|| product.get(0).getState().isEmpty()){
                    ...
                    if(product.get(0).getCategory().toUpperCase().contains("NA") || product.get(0).getCategory()== null || product.get(0).getCategory().isEmpty()){
...
//                    }
                    if(product.get(0).getBrand().toUpperCase().contains("NA") || product.get(0).getBrand()== null || product.get(0).getBrand().isEmpty()){
                    ...
                    if(product.get(0).getSowing_time().toUpperCase().contains("NA") || product.get(0).getSowing_time()== null|| product.get(0).getSowing_time().isEmpty()){
                    ...
                    if(product.get(0).getSeed_Rate().toUpperCase().contains("NA") || product.get(0).getSeed_Rate()== null || product.get(0).getSeed_Rate().isEmpty()){
                    ...
                    if(product.get(0).getMaturity_duration().toUpperCase().contains("NA") || product.get(0).getMaturity_duration() == null || product.get(0).getMaturity_duration().isEmpty()){
                    ...
                    if(product.get(0).getColour().toUpperCase().contains("NA") || product.get(0).getColour() == null || product.get(0).getColour().isEmpty()){
                    ...
                    if(product.get(0).getUsp().toUpperCase().contains("NA") || product.get(0).getUsp()== null || product.get(0).getUsp().isEmpty()){
                    ...
                    if(product.get(0).getNumberOfSeeds().toUpperCase().contains("NA") || product.get(0).getNumberOfSeeds()== null || product.get(0).getNumberOfSeeds().isEmpty()){
